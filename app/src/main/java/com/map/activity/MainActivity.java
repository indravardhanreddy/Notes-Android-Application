...
import com.map.App;
import com.map.R;
import com.map.adapter.DrawerAdapter;
import com.map.db.Controller;
import com.map.dialog.ImportDialog;
import com.map.dialog.SaveDialog;
import com.map.fragment.MainFragment;
import com.map.fragment.template.RecyclerFragment;
import com.map.inner.Animator;
import com.map.inner.Formatter;
import com.map.model.Drawer;
